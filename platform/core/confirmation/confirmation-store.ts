...
export type ConfirmationStore = {
   ...
   * ===========================================================================================
   *
   * `true` MEANS THIS REQUEST TOOK IT. `false` means it was already spent, has expired, or never
   * existed — three causes and one answer, which is the collapse this path wants: a caller learns
   * its confirmation is unusable and nothing about which of the three.
   *

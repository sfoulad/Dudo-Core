...
> **⚠ THIS INDEX IS HAND-MAINTAINED AND HAS ALREADY GONE STALE ONCE WITHOUT ANYTHING NOTICING.**
> **Population as of 2026-09-13: 44 records on disk, 44 rows above.** On that date **four were
> missing — `0041`, `0042`, `0043` and `0044`** — and they were found by deriving the difference
> rather than by reading the table, which is the only direction that works: **a row naming a deleted
> record is findable by a grep, and A MISSING ROW MATCHES NO PATTERN** (`workflow.md` §2b).
>
